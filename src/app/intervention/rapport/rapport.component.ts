...
ngOnInit(): void {
this.headerTitleService.setTitle('  Demande des piéces');
...
AllEtatattendPieces(){
  ...
  printdemandepiece(id:any){
    this.Serviceapibackend.printdemandepiece(id).subscribe(
      (data:any) => {
