...
export class DemandeinterventionListComponent implements OnInit {
  ...
  click : boolean = true;
  demandeintervention:any=Demandeintervention;
  constructor(    private route: ActivatedRoute,private sessionSotragesevice:SessionstorageService,private Serviceapibackend: BackendApiService,private headerTitleService: HeaderTitleService) { }
